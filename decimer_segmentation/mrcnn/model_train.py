...
MOLECULE_WEIGHTS_PATH = os.path.join(ROOT_DIR, 'decimer_segmentation/mask_rcnn_molecule.h5')
...
class GraphDataset(utils.Dataset):
    def load_graph(self, dataset_dir, subset):
        """Load a subset of the Graph dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("Graph", 1, "Graph")
...
def train(model):
    ...
    dataset_train.load_graph(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = GraphDataset()
    dataset_val.load_graph(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == "__main__":
    ...
    if args.weights.lower() == "coco":
        weights_path = MOLECULE_WEIGHTS_PATH
    ...
    if args.weights.lower() == "coco":
        ...
        try:
            ...
            try:
                ...
                print("Is not possible load the model. TIme 2")
    else:
        model.load_weights(weights_path, by_name=True)
